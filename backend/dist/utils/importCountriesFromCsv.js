...
// CSV文件路径
const csvFilePath = path_1.default.join(__dirname, '../../../country-codes.csv');
// 导入国家数据
        ...
        if (countries.length > 0) {
            try {
                ...
                for (let i = 0; i < countries.length; i += batchSize) {
                    ...
                    const inserted = await Country_1.default.bulkCreate(batch, {
                        validate: true,
...
// 执行导入
importCountries();
//# sourceMappingURL=importCountriesFromCsv.js.map